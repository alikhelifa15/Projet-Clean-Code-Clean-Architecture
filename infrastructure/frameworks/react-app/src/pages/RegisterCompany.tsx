      ...
      <div className="z-10 p-6 bg-white shadow-2xl rounded-lg max-w-sm md:max-w-md lg:max-w-lg my-10">
        <div className="w-full p-2 sm:p-12.5 xl:p-17.5">
          <h2 className="mb-1 text-2xl font-semibold sm:text-2xl text-center">
            Inscription <span className="text-primary">Pro</span>
          ...
          <div className="mb-4">
            ...
            <div className="mb-4">
              <label className="mb-2.5 block  text-black text-sm">Téléphone</label>
              <div className="relative">
                <input
                  type="text"
                  placeholder="0751458789"
                  className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                />
              </div>
            </div>
            <div className="mb-4">
              <label className="mb-2.5 block  text-black  text-sm">Nom d'enseigne</label>
              <div className="relative">
                <input
                  type="text"
            ...
            <div className="mb-4">
              <label className="mb-2.5 block  text-black  text-sm">Numéro SIRET</label>
              <div className="relative">
                <input
                  type="text"
                  placeholder="Ex: 123456789878"
                  className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                />
              </div>
            </div>
            <div className="mb-4">
              <label className="mb-2.5 block  text-black  text-sm">Adresse</label>
              <div className="relative">
                <input
                  type="text"
            ...
            <div className="mb-4">
              <label className="mb-2.5 block  text-black  text-sm">Code postal</label>
              <div className="relative">
                <input
                  type="text"
            ...
            <div className="mb-4">
              <label className="mb-2.5 block  text-black  text-sm">Ville</label>
              <div className="relative">
                <input
                  type="text"
