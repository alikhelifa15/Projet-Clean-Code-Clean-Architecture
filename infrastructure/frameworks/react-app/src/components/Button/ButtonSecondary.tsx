...
const ButtonSecondary: React.FC<ButtonSecondaryProps> = ({ to, children }) => {
  return (
    <Link
      to={to}
      rel="stylesheet"
      className="bg-white text-primary font-semibold px-5 py-4 rounded-lg border inline-flex items-center hover:shadow-6 transition-transform transform hover:scale-105"
    >
      {children}
      <svg
