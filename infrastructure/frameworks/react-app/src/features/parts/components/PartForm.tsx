...
interface FormData {
  ...
  // Effet pour initialiser/réinitialiser le formulaire
    ...
    const addMutation = useMutation({
        mutationFn: (data: FormData) => partApi.createPart(data),
        onSuccess: () => {
          queryClient.invalidateQueries({ queryKey: ["parts"] });
          onClose();
          toast.success("Piéce ajouté avec succès");
        },
        onError: (error) => {
          console.error("Erreur d'ajout:", error);
          toast.error("Erreur lors de l'ajout de la Piéce");
        },
      });
    ...
    const editMutation = useMutation({
        ...
        return partApi.updatePart(part.id.toString(), data);
        },
        onSuccess: () => {
        queryClient.invalidateQueries({ queryKey: ["parts"] });
        onClose();
        toast.success("Piéce modifié avec succès");
        },
        onError: (error) => {
        console.error("Erreur de modification:", error);
        toast.error("Erreur lors de la modification de la piéce");
        },
    });
